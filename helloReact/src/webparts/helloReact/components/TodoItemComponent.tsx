...
export default class TodoItemComponent extends React.Component<ITodoItemProps,ITodoItemState> {
    ...
    public render(): React.ReactElement<ITodoItemProps> {
        const resolvedIconName: string = (this.props.itemDone) ? "CheckboxComposite" : "Checkbox";
